...
def main():
    ...
    while True:
        ...
        caption1_1 = font.render("Player 1:", True, (255, 255, 255))
        caption1_2 = font.render("r - up d - left", True, (255, 255, 255))
        caption1_3 = font.render("f - down g - right", True, (255, 255, 255))
        caption1_4 = font.render("a - shoot q - melee", True, (255, 255, 255))
        caption2_1 = font.render("Player 2:", True, (255, 255, 255))
        caption2_2 = font.render("arrow keys", True, (255, 255, 255))
        caption2_3 = font.render(", - shoot . - melee", True, (255, 255, 255))
